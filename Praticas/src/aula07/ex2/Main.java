...
public class Main {
    ...
    public static void menu(){
        // TODO: Display the 'tester' menu of class 'Date'
    ...
    public static void createDate(){
        ...
        int optionCreate;
        do {
            optionCreate = UserInput.IntegerInput(0,2, """
            
            Create date:
            1 - Normal date
            2 - Distance to 2000-01-01
            0 - back
            ...
            if(optionCreate == 1){
                ...
                System.out.print("Distance to 2000-01-01 (days): ");
                distanceTo = sc.nextInt();

                date = new DateND(distanceTo);
                break;
            }
