...
public class POO2223 {
	...
	private static void alinea2() throws FileNotFoundException {
		print("\n\nAlínea 2) ----------------------------------\n");
        ...
        Scanner input = new Scanner(new FileReader("src/digital_objects.txt"));
        ...
        while(input.hasNextLine()){
            ...
            content = line.split(";");
            user = assetManager.getUser(content[1]);
            level = SensitivityLevel.valueOf(content[2]);
            assetManager.registerDigitalObject(content[0],level,user);
        }
